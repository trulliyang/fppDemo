...
//        Log.e("", "### read pixel takes "  + (end - start)) ;
//
...
//                    bitmapFaceDetector = new BitmapFaceDetector(DecodeToSurfaceActivity.sAppContext, mWidth, mHeight) ;
//                }
//                bitmapFaceDetector.detectFaces( mPixelBuf.array()) ;
//            } catch (Throwable e) {
//                e.printStackTrace();
//                Log.e("", "### detect faces exp : " + e) ;
//            }
//        } catch (Throwable e) {
//            e.printStackTrace();
//        } finally {
...
////            }
//        }
//        Log.e("", "### detect faces takes "  + (System.currentTimeMillis() - end)) ;
//
//        if (VERBOSE && bmp != null ) {
...
//    BitmapFaceDetector bitmapFaceDetector ;
