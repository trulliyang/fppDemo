...
import com.facepp.demo.decoder.DecodeToSurfaceActivity;
import com.facepp.demo.network.FaceppNetworkApi;
import com.facepp.demo.parser.FacePointParser;
...
public class FaceppActionActivity extends Activity implements OnClickListener {
    ...
    private boolean isStartRecorder, is3DPose, isDebug, isROIDetect, is106Points = true, isBackCamera, isFaceProperty,
...
//        }, 500);
        ...
        findViewById(R.id.landmark_title).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                DecodeToSurfaceActivity.start(FaceppActionActivity.this);
            }
        });

        new FaceppNetworkApi().detectFacesFromImageFile(new File("/sdcard/face001.jpg"), new FaceppNetworkApi.OnFaceJsonListener() {
            @Override
            public void onFacesJson(JSONObject jsonObject) {
                FacePointParser pointParser = new FacePointParser(jsonObject) ;
                pointParser.parse();
                pointParser.showPoints();
            }
        });
    }
    ...
    private void init() {
        ...
        Button videoBtn = (Button) findViewById(R.id.video_enterBtn);
        enterBtn.setText(getResources().getString(R.string.detect_face));
        enterBtn.setOnClickListener(this);
        videoBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FaceppActionActivity.this, VideoOpenglActivity.class));
            }
        });
...
//					.putExtra("isFaceCompare", isFaceCompare));
        ...
        } else if ( ID == R.id.video_enterBtn ) {
        }
    }
